...
def main():
    ...
    # query the gene symbols for the ensemble ids and convert result to dataframe
    ...
    # view first 5 rows of data
    print("\nFirst 5 rows of data with gene names:")
    print(countlist_5xFAD.head())
    ...
    output_csv = "5xFAD_processed_data.csv"
